...
import { VolunteerSettingParamList } from "../../navigation/types";

type VolunteerSettingProps = NativeStackScreenProps<
...
export default function VolunteerSettings({
  navigation,
}: VolunteerSettingProps) {
  const handleAccount = () => {
    navigation.navigate("Volunteer-Edit");
  };
